...
- パーツの実物カタログ: デバッグ専用のギャラリー画面 `/gallery`（開き方・削除手順は `lib/features/gallery/README.md`）。`lib/core/widgets/` にパーツを追加したらギャラリーにもサンプルを足す
- **実装ステータス: 15画面すべて反映済み（2026-08-02。ペイウォール・ギャラリー追加）**
